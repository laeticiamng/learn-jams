...
import { Upload, Music, Headphones, BookOpen, Brain, Shield, ChevronDown, Repeat, Timer, Dumbbell } from "lucide-react";
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-3xl">
          <div className="glass-card p-8 text-center">
            <h2 className="font-display text-2xl font-bold mb-4">{t("home.summary_title")}</h2>
            <p className="text-muted-foreground leading-relaxed" dangerouslySetInnerHTML={{ __html: t("home.summary_text") }} />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[1, 2, 3].map((n, i) => {
              ...
              return (
                <motion.article key={n} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
