...
function makeM3Output(overrides: Partial<M3_Output> = {}): M3_Output {
  return {
    ...
    repetition_plan: [
      { concept_key: "c1", moments: ["inline", "end_of_segment", "final_test"], is_critical: true },
    ],
    mnemonics: [{ concept_keys: ["c1"], mnemonic: "Remember C1", type: "acronym" }],
    visual_anchors: [{ concept_key: "c1", content: "Visualize c1 as a tree", anchor_type: "image" }],
